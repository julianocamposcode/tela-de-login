...
const checkboxCad = document.querySelector('.checkboxCad')
...
formCad.addEventListener('submit', (event) => {
    ...
    if (verificaCamposCad()) {
        ...
        localStorage.telefone = tel.value
        localStorage.valuetTextarea = textarea.value
        localStorage.valueRange = range.value
    }
...
function verificaCamposCad() {
    ...
    const telefoneValidoCad = verificaCampoTelCad('');
    return emailValidoCad && senhaValidaCad && nomeValidoCad && telefoneValidoCad
}
